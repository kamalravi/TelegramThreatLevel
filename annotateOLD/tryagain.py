...
def classify_text(text):
    prompt = "Classify the statement into one of the six classes:\n\n1. Claims of illegal/criminal actions/behavior: Statements that allege or assert that a person or group committed or is engaging in illegal or criminal activities (excluding heinous crimes) without explicitly calling for arrest, prosecution, punishment, harm, or other action.\n2. Claims of immoral/evil behaviors: Statements that assert that a person or group is immoral or evil, or that they are committing heinous crimes.\n3. Statements that suggest or imply support for arrest, prosecution, punishment, or other harmful or threatening actions, but without explicit instructions or clear intent.\n4. Statements that explicitly call for or threaten legal action against a person or group in the form of civil action, arrest, or criminal prosecution.\n5. Calls/threats for non-judicial or extra-judicial action/harm: Statements that explicitly call for or threaten non-judicial or extra-judicial action or harm against a person or group, such as execution, physical violence, or vigilante justice.\n6. None of the above: No indication, suggestion, or desire of  physical harm, imprisonment, or threat towards another person, persons, group, or organization.\n\nstatement: \"" + text + "\""
...
# Example usage
text = "Bout time im still pissed they allowed the FALSE installment of Biden."
